    ...
    <div>
      <Box className="bg-white pb-[5rem]">
          <Grid container className='px-[1rem]'>
              ...
              <h1 className='text-start sm:text-center  md:text-start pt-[5rem] font-semibold text-[#252849] sm:px-[4rem] md:px-[1rem]'>Our <span className='text-light-blue'>Qualified Doctors</span></h1>
