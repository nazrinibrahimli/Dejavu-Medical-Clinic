  ...
  return (
      <div className='rounded-xl mx-[3rem] pb-[3rem]'>
        <Box sx={{ flexGrow: 1 }} className=" mx-[2rem] rounded-xl  ">
          <h1 className='text-center pt-[5rem] font-semibold text-[#252849]'>Our <span className='text-[#072852]'>Main Services</span> Categories</h1>
          <Grid container spacing={2} className="py-[3.5rem]">
                  
      <Grid item xs={12} md={6} lg={4} className="">
       <Card  sx={{ maxWidth: 350,maxHeight: 590, borderRadius: 5 ,backgroundColor:"#4c874a" }}  className="transitioned-card mx-auto">
      <CardMedia
        sx={{ height: 180 }}
      ...
      <CardContent sx={{mx:2, mb:3}}>
        ...
        <Typography variant="body1" color="" className='font-sans h-[7rem] text-white'>
...
<Grid item xs={12} md={6} lg={4}>
      ...
      <CardActions  sx={{mx:2, mb:3}}>
        ...
        <Grid item xs={12} md={6} lg={4}>
       <Card sx={{ maxWidth: 350,maxHeight: 590,borderRadius: 5 ,}} className="transitioned-card mx-auto bg-[#4c874a]">
       <CardMedia
        sx={{ height: 180 }}
